...
public class FishFromTheDocksEvent : MonoBehaviour
{
    ...
    public string Run()
    {
        ...
        else if (finalOutcome == 2)
        {
            ...
            eg.setEntropy(eg.getEntropy() + 0.025f);
            return "You spend hours fishing with no luck. But then all of a sudden you see a glimpse of gold in the water and attempt to hook it with your fishing rod. You fish it up and uncover an ancient golden idol. You sell it for 130 coins to the highest bidder";
        }
