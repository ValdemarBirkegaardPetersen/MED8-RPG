...
public class MedidateAtShrineEvent : MonoBehaviour
{
    ...
    public string Run()
    {
        ...
        else if (finalOutcome == 2)
        {
            ...
            return "You spend hours resting and meditating at the shrine with peaceful thoughts. You feel more good-minded and positive after a while. As a sign of good fortune, you find a coin in the grass. \n(Currency +1)";
        }
